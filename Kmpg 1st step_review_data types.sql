...
--B.  product_first_sold_date is float, we need to convert it to datetype.
...
SELECT customer_id, ROUND(Sum(List_Price),0) AS Total_Purchase_value FROM [dbo].[UNIFIEDTHREE]
